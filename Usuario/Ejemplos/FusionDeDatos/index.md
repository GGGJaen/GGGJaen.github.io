...
![Ventana de consulta para nubes de puntos con distintivo *Puente*](./fusion_hiper_querynube.png)
...
![Visualización del resultado de la fusión hiperespectral sobre la nube cargada en GEU](./fusion_hiper_result.png)
